...
Spring::Spring(RigidBody* a_actor1, RigidBody* a_actor2, float a_damping, float a_springCoefficient,
	float a_restLength, glm::vec2 a_contact1, glm::vec2 a_contact2) : PhysicsObject(JOINT),
